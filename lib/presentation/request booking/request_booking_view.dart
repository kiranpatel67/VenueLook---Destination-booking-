      ...
      body: Stack(
          ...
          children: [
            PageView.builder(
              ...
              onPageChanged: (index) {
                if (index ==
                    (controller.destination.value?.propertyImages!.length ??
                        0) -
                        1) {
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${controller.bookingData.value?.destination_policy
                              ?.join('\n')}',
                          style: TextStyle(color: Color(0xFF71797E)),
                        ),
                        SizedBox(
                        ...
                        Padding(
                          ...
                          child: Center(
                            child: AnimatedSmoothIndicator(
                              ...
                              count: controller.destination.value?.propertyImages?.length ?? 0,
                              effect: WormEffect(
                                dotWidth: 10,
                                dotHeight: 10,
